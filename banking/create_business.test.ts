...
test.concurrent("create business account", { timeout: 60_000 }, async ({
  ctx,
  browser,
}) => {
  ...
  await page.getByRole("link", { name: "fill information about your" }).click();
  ...
  await page.locator("#company_info_date_of_incorporation").fill("11.11.2002");
  await page
  ...
  await page.locator("#company_info_major_partners").fill(faker.company.name());
