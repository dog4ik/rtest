...
export const PayoutRequestSchema = (settingsSchema: z.ZodType) => {
  return z.object({
    params: ParamsSchema,
...
export type ConnectPayoutRequest = z.infer<typeof PayoutRequestSchema>;

export type ConnectPayoutResponse = {
  result: boolean;
  logs: InteractionLog[];
