...
describe
  ...
  .concurrent("ip country rules", () => {
    ...
    test.concurrent("not_in_ip_country allows IP not from banned country", ({
      ctx,
      merchant,
    }) =>
      ctx.track_bg_rejections(async () => {
    ...
    test.concurrent("ip_in_country allows IP from whitelisted country", ({
      ctx,
      merchant,
    }) =>
      ctx.track_bg_rejections(async () => {
    ...
    test.concurrent("ip_in_country blocks IP not from whitelisted country", ({
      ctx,
      merchant,
    }) =>
      ctx.track_bg_rejections(async () => {
    ...
    test.concurrent("not_in_ip_country allows unknown IP", ({
      ctx,
      merchant,
    }) =>
      ctx.track_bg_rejections(async () => {
