...
import { type CommonSettingsParams, providers } from "@/settings_builder";
...
describe.runIf(PROJECT === "8pay").concurrent("madsolution disputes", () => {
  ...
  test.concurrent("madsolution dispute callback finalization to declined", ({
    ctx,
  }) =>
    ctx.track_bg_rejections(async () => {
      let { init_response, madsolution, merchant, payment } =
  ...
  test.concurrent("madsolution dispute callback finalization to approved", ({
    ctx,
  }) =>
    ctx.track_bg_rejections(async () => {
      let { init_response, madsolution, merchant, payment } =
  ...
  test.concurrent("madsolution dispute changed amount finalization to approved", ({
    ctx,
  }) =>
    ctx.track_bg_rejections(async () => {
      let { init_response, madsolution, merchant, payment } =
  ...
  test.concurrent("madsolution dispute should not be created on successful transaction", ({
    ctx,
  }) =>
    ctx.track_bg_rejections(async () => {
  ...
  test.concurrent("madsolution concurrent duplicate disputes should not be created", ({
    ctx,
  }) =>
    ctx.track_bg_rejections(async () => {
      let { init_response, madsolution, merchant, payment } =
  ...
  test.concurrent("madsolution new dispute after approved should not be created", ({
    ctx,
  }) =>
    ctx.track_bg_rejections(async () => {
      let { init_response, madsolution, merchant, payment } =
  ...
  test.concurrent("madsolution status should not change after successful dispute", ({
    ctx,
  }) =>
    ctx.track_bg_rejections(async () => {
  ...
  test.concurrent("madsolution status should not change if have pending dispute", ({
    ctx,
  }) =>
    ctx.track_bg_rejections(async () => {
      let { merchant, madsolution, payment, init_response } =
  ...
  test.concurrent("madsolution dispute double callback / merchant notification", ({
    ctx,
  }) =>
    ctx.track_bg_rejections(async () => {
      let { init_response, madsolution, merchant, payment } =
